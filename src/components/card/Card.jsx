...
//       bougie.stock -= 1;
//       setEuro((prevEuro) => prevEuro - prix);
...
//                 ) : (
//                   <p className={bougie.stock < 5 ? "text-orange-600" : ""}>
...
//               <div>
//                 <button
//                   disabled={bougie.stock === 0 || euro < (tailleChoisie === "Petite" ? bougie.prix1 : bougie.prix2)}
//                   onClick={() => ajouterAuPanier(bougie, tailleChoisie)}
//                 >
//                   Ajouter
//                 </button>
//                 <button
//                   disabled={panierCount === 0}
...
const ajouterAuPanier = (bougie, tailleChoisie) => {
  ...
  if (bougie.stock > 0 && euro >= prix) {
    ...
    bougie.stock -= 1;
    setEuro((prevEuro) => Math.round(prevEuro - prix)); // ✅ Arrondi
    setPanierCount((prevCount) => prevCount + 1);
  }
};
